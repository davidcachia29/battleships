    ...
    void OnMouseOver()
    {
        ...
        { 
            if (Input.GetMouseButtonDown(0))
            {
                ...
                gm.currentlySelectedShip.place(indexX, indexY, false, gm.playerGrid, gm.currentbutton);
            ...
            if (Input.GetMouseButtonDown(1))
            {
                ...
                gm.currentlySelectedShip.place(indexX, indexY, true,gm.playerGrid, gm.currentbutton);
              //  flipColor();
            }
        }
